    ...
    <footer className="site-footer" id="contato">
      <div className="wrap footer-wrap">
        <div className="footer-top">
          <Link to="/" className="footer-brand" aria-label="MALSYN - Página inicial">
          ...
          <div className="footer-contacts">
            <span className="footer-contacts-label">Contato & Redes</span>
            <div className="footer-contacts-group">
              <a
                href="https://wa.me/5531999990000?text=Ol%C3%A1%2C%20Malsyn!%20Gostaria%20de%20conversar%20sobre%20um%20projeto."
                target="_blank"
                rel="noopener noreferrer"
                className="footer-contact-pill whatsapp"
              >
              ...
              <a
                href="https://www.instagram.com/malsyn.tech/"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-contact-pill instagram"
              >
                <svg className="pill-icon" viewBox="0 0 24 24" fill="currentColor">
                ...
                <span>Instagram @malsyn.tech</span>
                <span className="arrow-icon">↗</span>
              </a>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <span>© {currentYear} Malsyn. Todos os direitos reservados.</span>
        </div>
      </div>
    </footer>
  );
