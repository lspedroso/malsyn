...
const planos = [
  {
    ...
    prefixo: 'A partir de',
    preco: '850',
    ciclo: 'pagamento único · ou mensal · valores alinhados via WhatsApp',
    ...
    itens: [
      ...
      'Suporte técnico (se mensal) sempre que precisar!',
    ],
    destaque: false,
    ...
    <main className="planos-page">
      <section className="orcamento-hero">
        <div className="wrap">
          ...
          <p>
            Desenvolvimento profissional com código exclusivo, e com acompanhamento direto. Escolha o plano que melhor atende à sua empresa.
          </p>
          ...
          {planos.map((p) => {
            ...
            return (
              ...
              >
                ...
                <h2 className="plan-name">{p.nome}</h2>
